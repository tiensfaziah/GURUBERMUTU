...
const WorkshopDetail = () => {
  ...
  useEffect(() => {
    const loadWorkshop = async () => {
      try {
        // Ambil data workshop dari Firestore
  ...
  const handleComplete = async () => {
    try {
      ...
      if (!key) {
        alert("Workshop belum memiliki mapping Skill Tree.");
        return;
      }

      // gunakan reward jika xp tidak ada
      ...
      if (!docSnap.exists()) {
        ...
        const newCompleted =
          (data.completedModules || 0) + 1;

        const levelData = getLevel(newXP);

        const newBadges =
          getBadges(newXP, newCompleted);
  ...
  <div className="min-h-screen pb-16" style={{ background: "#F5F3FF" }}>
    ...
    <div className="max-w-4xl mx-auto px-4 md:px-6 pt-4 md:pt-6">
      <div
        ...
        style={{
          background:
            "linear-gradient(155deg, #2D1B69 0%, #3D2380 65%, #4C2A99 100%)",
          minHeight: 240,
        }}
      >
        <svg
          ...
          <div className="bg-white border border-purple-100 rounded-2xl p-4 shadow-[0_2px_10px_-4px_rgba(91,33,182,0.08)]">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs text-gray-400 leading-relaxed">
                {workshop.friendsGoing.join(", ")} sudah mendaftar
              </p>
            </div>
          </div>
        )}
        ...
        <div className="bg-white border border-purple-100 rounded-2xl p-5 md:sticky md:top-6 shadow-[0_8px_30px_-8px_rgba(91,33,182,0.15)] space-y-4">
          ...
          <div className="border-t border-purple-50 pt-4">
            ...
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <p className="text-xs text-gray-400">
                Reward menyelesaikan di GuruBermutu
              </p>

            </div>

            <p
              className="text-2xl font-bold mb-3.5"
              style={{ color: "#EC4899" }}
            >
            ...
            <button
              ...
              title={
                !hasRegistered
                  ? "Daftar workshop terlebih dahulu."
                  : ""
              }
              ...
              style={
                completed
                  ...
                  : {
                      ...
                      color: "#fff",
                      boxShadow:
                        "0 6px 18px -6px rgba(236,72,153,0.55)",
                    }
              }
            >
              {completed
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M8.684 13.342a3 3 0 100-2.684m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 8.658a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z"
              />
            </svg>
            Bagikan Workshop
          </button>
